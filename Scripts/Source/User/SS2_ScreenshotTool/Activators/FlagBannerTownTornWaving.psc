scriptname SS2_ScreenshotTool:Activators:FlagBannerTownTornWaving extends SS2_ScreenshotTool:Activators:Flag
...
Function Capture(SimSettlementsV2:Armors:ThemeDefinition_Flags thisForm)
	CheckIndexing()
	CaptureModel(thisForm.FlagBannerTownTornWaving)
EndFunction