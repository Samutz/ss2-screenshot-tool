...
Function IndexBuildingPlan(SimSettlementsV2:Weapons:BuildingPlan thisItem)
	...
	elseif thisItem.HasKeyWord(SS2_PlotType_Municipal) && thisItem.HasKeyWord(SS2_PlotSize_1x1)
		SS2SST_Index_BuildingPlans_Municipal_1x1.AddForm(thisItem)
	elseif thisItem.HasKeyWord(SS2_PlotType_Municipal) && thisItem.HasKeyWord(SS2_PlotSize_2x2)
		SS2SST_Index_BuildingPlans_Municipal_2x2.AddForm(thisItem)
	elseif thisItem.HasKeyWord(SS2_PlotType_Municipal) && thisItem.HasKeyWord(SS2_PlotSize_3x3)
		SS2SST_Index_BuildingPlans_Municipal_3x3.AddForm(thisItem)
